...
export const holderDocumentsAdapter: EntityAdapter<HolderDocument> =
  createEntityAdapter<HolderDocument>({
    selectId: (holderDocument) => holderDocument.id,
    //sortComparer: (a, b) => a.holderId.localeCompare(b.documentName)
  });

export const holderDocumentsSelectors =
  holderDocumentsAdapter.getSelectors<RootState>(
